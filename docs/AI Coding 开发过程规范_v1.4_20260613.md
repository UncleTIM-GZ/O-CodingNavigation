...
版本：1.4
发布日期：2026-06-13
基于工具版本：O'CodingNavigator 0.6.0（`o-coding-navigation@0.6.0-beta.0`）· SOP profile 0.5.0（自动模式为引擎/CLI 特性，包版本与 SOP 版本自本版起解耦）
