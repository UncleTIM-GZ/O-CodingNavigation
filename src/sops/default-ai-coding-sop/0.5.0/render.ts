...
// SOP 0.5.0 — renders the canonical 0.5.0 profile data into the YAML snapshot
// strings persisted under .ocoding/. Identical hand-rolled emission to 0.4.0
// (stable line ordering, diffable against fixtures); only the data source
// differs (step_build_plan gains section_task_specs — AM-007/DEC-032). Every
// field derives from data.ts so the snapshot can never drift from the runtime
// profile.
