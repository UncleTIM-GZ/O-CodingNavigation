// SOP 0.8.0 bundled default config — the runtime default since AM-015/DEC-041
// (Acceptance Backbone). Written by fresh `ocn init` and by
// `ocn init --sop-version 0.8.0`. Identical to 0.7.0 except the pinned
