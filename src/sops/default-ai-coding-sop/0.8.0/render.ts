...
// SOP 0.8.0 — renders the canonical 0.8.0 profile data into the YAML snapshot
// strings persisted under .ocoding/. Emission is identical to 0.7.0 (stable
// line ordering, diffable against fixtures); step_acceptance_criteria now
// carries section_acceptance_specs (AM-015). Every field derives from data.ts
// so the snapshot can never drift from the runtime profile.
