// SOP 0.7.0 bundled default config — the runtime default since DEC-039
// (npm/SOP version unification). Written by fresh `ocn init` and by
// `ocn init --sop-version 0.7.0`. Identical to 0.5.0 except the pinned
