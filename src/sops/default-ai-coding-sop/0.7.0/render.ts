...
// SOP 0.7.0 — renders the canonical 0.7.0 profile data into the YAML snapshot
// strings persisted under .ocoding/. Emission is identical to 0.5.0 (stable
// line ordering, diffable against fixtures); only the version string in the
// header differs (0.7.0). Every field derives from data.ts so the snapshot
// can never drift from the runtime profile.
