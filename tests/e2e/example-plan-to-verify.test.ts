...
const FULL_PATH: readonly Step[] = [
  { stateId: "state_discovery", stepId: "step_project_brief", artifactPath: "docs/00-project-brief.md" },
  ...
  { stateId: "state_spec", stepId: "step_acceptance_criteria", artifactPath: "docs/03-acceptance-criteria.md" },
  { stateId: "state_design", stepId: "step_technical_architecture", artifactPath: "docs/04-technical-architecture.md" },
  { stateId: "state_design", stepId: "step_information_architecture", artifactPath: "docs/05-information-architecture.md" },
  ...
  { stateId: "state_design", stepId: "step_test_strategy", artifactPath: "docs/08-test-strategy.md" },
  ...
  { stateId: "state_build", stepId: "step_implementation_log", artifactPath: "docs/11-implementation-log.md" },
  { stateId: "state_build", stepId: "step_change_evidence", artifactPath: "docs/12-change-evidence.md" },
  { stateId: "state_build", stepId: "step_integration_notes", artifactPath: "docs/13-integration-notes.md" },
  { stateId: "state_verify", stepId: "step_verification_report", artifactPath: "docs/14-verification-report.md" },
  { stateId: "state_verify", stepId: "step_acceptance_mapping", artifactPath: "docs/15-acceptance-mapping.md" },
  { stateId: "state_verify", stepId: "step_failure_fix_log", artifactPath: "docs/16-failure-fix-log.md" },
  { stateId: "state_verify", stepId: "step_regression_evidence", artifactPath: "docs/17-regression-evidence.md" },
  { stateId: "state_verify", stepId: "step_final_build_verdict", artifactPath: "docs/18-final-build-verdict.md" },
];
...
describe("examples/plan-to-verify — fixture smoke (SOP 0.2.0)", () => {
  ...
  it("ships exactly 19 example doc fixtures matching FULL_PATH order", async () => {
  ...
  it(
    "walks all 19 wired SOP 0.2.0 steps using the example docs and terminates cleanly",
    async () => {
      const cwd = project.cwd;

      // 1. ocn init — fresh DISCOVERY state under SOP 0.2.0.
      ...
      expect(initState.project.sopProfileVersion).toBe("0.2.0");
      ...
      const docNames = (await fs.readdir(EXAMPLE_DOCS_DIR)).filter((n) =>
        n.endsWith(".md"),
      );
