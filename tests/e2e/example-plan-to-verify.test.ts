...
const FULL_PATH: readonly Step[] = [
  ...
  { stateId: "state_design", stepId: "step_api_contract", artifactPath: "docs/08-api-contract.md" },
  {
    stateId: "state_design",
    stepId: "step_test_strategy",
    artifactPath: "docs/09-test-strategy.md",
  },
  { stateId: "state_plan", stepId: "step_mvp_plan", artifactPath: "docs/10-mvp-plan.md" },
  { stateId: "state_plan", stepId: "step_build_plan", artifactPath: "docs/11-build-plan.md" },
  {
    stateId: "state_build",
